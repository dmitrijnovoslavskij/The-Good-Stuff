...
Tune (0, 0) -> EQ (60 hz hpf - male, 110 hz hpf - female, f0 bell attenuation by ear, nothing else) -> Gate -> Comp (minimal attack, minimal release, -10 db GR Peak) -> De-essor (Default Settings, Wideband) -> Modulation (10% - 20%) -> Wet (add Fruity Panomatic on adlibs with Pan LFO)
